...
export function createTaskStateService(deps = {}) {
    ...
    function normalizeMemoryItem(memory = {}, index = 0) {
        ...
        // Opening messages were generated by an obsolete AI path and are not
        // part of the task-state contract anymore.
        delete normalized.chapterOpeningPreview;
        delete normalized.chapterOpeningSent;
        delete normalized.chapterOpeningError;
        delete normalized.chapterOpeningGenerating;
