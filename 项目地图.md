...
当前图谱规模：`87 files` / `1080 nodes` / `3116 edges`。
...
- `services/processingService.js`（3,558 行）、`services/directorService.js`（2,193 行）、`ui/chapterExperienceView.js`（1,707 行）是业务热点；前三个合计约 7,458 行。前十个最大文件合计 15,962 行，占 JS/MJS 总行数 31,244 行的约 51%，说明复杂度高度集中。
